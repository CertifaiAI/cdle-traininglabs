...
public class FaceRecognitionVideo {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        // STEP 1: Create a folder with your name (eg. KengHooi) under "dl4j-cv-labs/src/main/resources/FaceDB"

        // STEP 2: Place some of your cropped face images under the folder you created

        // STEP 3: Place your video file under "dl4j-cv-labs/src/main/resources/FaceRecognition_input/video/"
        ...
        if (folder.listFiles().length < 1) {
            ...
            // STEP 6: Select your FaceIdentifier
            // ENTER YOUR CODE HERE
            ...
            for (int i = 0; i < folder.listFiles().length; i++) {
                ...
                while (videoCapture.read(image)) {
                    ...
                    // STEP 8: Perform face recognition
                    // ENTER YOUR CODE HERE

                    // STEP 9: Display output in a window
                    // ENTER YOUR CODE HERE

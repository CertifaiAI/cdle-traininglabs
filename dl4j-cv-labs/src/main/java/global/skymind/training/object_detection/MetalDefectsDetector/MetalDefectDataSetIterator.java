...
import global.skymind.training.object_detection.MetalDefectsDetector.dataHelpers.LabelImgXmlLabelProvider;
...
public class MetalDefectDataSetIterator {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(MetalDefectDataSetIterator.class);

...
public class Ex1_CreatingINDArrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BLACK_BOLD + "Nd4j.create(new double[]{1,2,3})" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.create(new double[]{1,2,3}, 3, 1)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.create(new double[][]{{1,2,3},{4,5,6}})" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.rand(nRows, nColumns)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.rand(new int[]{2, nRows, nColumns})" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.randn(nRows, nColumns)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.rand(nRows, nColumns, seed)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.eye(3)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.linspace(1,20,10)" + ANSI_RESET);
        ...
        System.out.println(BLACK_BOLD + "Nd4j.diag(Nd4j.create(new double[]{4,5,6}))" + ANSI_RESET);

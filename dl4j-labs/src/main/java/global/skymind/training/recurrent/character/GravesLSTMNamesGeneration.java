...
import org.deeplearning4j.solution.recurrent.character.CharacterIterator;
...
public class GravesLSTMNamesGeneration {
    public static void main(String[] args) throws Exception {
        ...
        */
        CharacterIterator iter = null;//getIterator(miniBatchSize, exampleLength);

        if(iter == null)
        {
            System.out.println("Iterator of Data is null. Abort");
            return;
        }
		...
		*/
        MultiLayerConfiguration conf = null;/*new NeuralNetConfiguration.Builder()
            .seed(12345)
            .l2(0.0001)

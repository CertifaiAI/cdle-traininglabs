 ...
 */
public class tmpDoubleExponentialSmoothingOildata extends ApplicationFrame {
    /**
     * Constructs a new demonstration application.
     *
     * @param title the frame title.
     */
    public tmpDoubleExponentialSmoothingOildata(final String title) {

        super(title);

        double[] testData = {446.6565, 454.4733, 455.663, 423.6322, 456.2713, 440.5881, 425.3325, 485.1494, 506.0482, 526.792, 514.2689, 494.211};
...
//            rangeAxis.setTickUnit(new NumberTickUnit(500));
        ...
        return new JFreeChart(tmpDoubleExponentialSmoothingOildata.class.getCanonicalName(), JFreeChart.DEFAULT_TITLE_FONT, plot, true);
    }
    ...
    public static void main(final String[] args) {
        final tmpDoubleExponentialSmoothingOildata demo = new tmpDoubleExponentialSmoothingOildata("Moving Average");
        demo.pack();
